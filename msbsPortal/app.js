var app = angular.module('mapp', ['navHeaderApp', 'nrmainapp', 'drHomeApp', 'patHomeApp', 'regmainapp', 'regapp', 'ui.router']);
app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
            ...
            .state('drHome', {
                url: '/drHome',
                templateUrl: 'msbsPortal/components/doctors/drHome/drHome.html',
                controller: 'drHomeAppControl'
            })
            .state('patHome', {
                url: '/patHome',
                templateUrl: 'msbsPortal/components/patients/patHome/patHome.html',
                controller: 'patHomeAppControl'
            });
//            .state('home', {
//                url: '/home',
...
var navHeaderApp = angular.module("navHeaderApp", ['homeApp', 'aboutApp', 'facilityApp', 'drLoginApp', 'patLoginApp', 'specialityApp', 'pharmacyApp', 'contactUsApp', 'ui.router']);
...
navHeaderApp.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
            ...
            .state('navHeader.doctors', {
                url: '/login',
                templateUrl: 'msbsPortal/components/doctors/drLogin/drLogin.html',
                controller: 'drLoginAppControl'
            })
            .state('navHeader.patients', {
                url: '/login',
                templateUrl: 'msbsPortal/components/patients/patLogin/patLogin.html',
                controller: 'patLoginAppControl'
            })
...
var drLoginApp = angular.module("drLoginApp", []);
drLoginApp.controller("drLoginAppControl", function ($scope, $state) {

});

var patLoginApp = angular.module("patLoginApp", []);
patLoginApp.controller("patLoginAppControl", function ($scope, $state) {
