...
var navHeaderApp = angular.module("navHeaderApp", ['homeApp', 'aboutApp', 'facilityApp', 'doctorsApp', 'patientsApp', 'specialityApp', 'farmacyApp', 'contactUsApp', 'ui.router']);
...
navHeaderApp.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
            ...
            .state('navHeader.farmacy', {
                url: '/farmacy',
                templateUrl: 'msbsPortal/components/farmacy/farmacy.html',
                controller: 'farmacyAppControl'
            })
...
var farmacyApp = angular.module("farmacyApp", []);
farmacyApp.controller("farmacyAppControl", function ($scope, $state) {
